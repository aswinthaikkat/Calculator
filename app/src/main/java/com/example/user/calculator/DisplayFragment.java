 ...
 */
public class DisplayFragment extends Fragment implements Contract.PublishToView {

    private Contract.ForwardDisplayInteractionToPresenter forwardInteraction;

    public void setPresenter (Contract.ForwardDisplayInteractionToPresenter
                                      forwardInteraction){
